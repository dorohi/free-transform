...
exports.default = function (scaleType, _ref, onUpdate) {
  var event = _ref.event,
      ...
      height = _ref.height,
      angle = _ref.angle,
      scaleMinLimit = _ref.scaleMinLimit,
      scaleMaxLimit = _ref.scaleMaxLimit,
  ...
  var drag = function drag(event) {
    ...
    var currentScaleX = rotationPoint.x / width;
    currentProps.scaleX = currentScaleX < scaleMinLimit ? scaleMinLimit : currentScaleX > scaleMaxLimit ? scaleMaxLimit : currentScaleX;

    var currentScaleY = rotationPoint.y / height;
    currentProps.scaleY = currentScaleY < scaleMinLimit ? scaleMinLimit : currentScaleY > scaleMaxLimit ? scaleMaxLimit : currentScaleY;
